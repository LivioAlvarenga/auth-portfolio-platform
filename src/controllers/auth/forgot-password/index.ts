...
import { makeForgotPasswordUseCase } from '@/use-cases/auth/forgot-password/make-forgot-password'
...
export async function forgotPassword(req: NextRequest) {
  ...
  try {
    ...
    if (error instanceof z.ZodError) {
      console.error(
        '💥 Unexpected error during data sanitization in api/v1/auth/forgot-password',
        error,
      )
    ...
    console.error('💥 Unexpected error in api/v1/auth/forgot-password', error)
